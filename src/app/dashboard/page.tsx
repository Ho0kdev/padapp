      ...
      <DashboardLayout>
        <div className="flex items-center justify-center h-96">
          <div className="text-center px-4">
            <h3 className="text-base sm:text-lg font-semibold text-red-600">Error al cargar el dashboard</h3>
            <p className="text-sm sm:text-base text-muted-foreground">Por favor, recarga la página</p>
          </div>
        </div>
      </DashboardLayout>
    )
